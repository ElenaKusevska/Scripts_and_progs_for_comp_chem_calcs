...
then
   ...
   echo "optimized_geometries.xyz found and deleted"
fi
...
do
   ...
   then
      ...
      then
         ...
         echo $i $(grep 'Sum of electronic and thermal Free Energies=' *out | tail -1 | cut -c54-65)| cat >> ../optimized_geometries.xyz
