...
def prepare_slurm_file(inputname, memory, nproc):
    # create file name. Delete it if it exists.
    ...
    slurmfile.write('\n')
    slurmfile.write('#SBATCH --time=96:00:00')
    slurmfile.write('\n')
    ...
    slurmfile.write('\n')
    slurmfile.write('module load gaussian/D.01')
    slurmfile.write('\n')
    slurmfile.write(' ')
    slurmfile.write('\n')
    slurmfile.write('cp ' + inputname + '.g09 $SLURM_SCRATCH')
    slurmfile.write('\n')
    ...
    slurmfile.write(' ')
    slurmfile.write('\n')
    slurmfile.write('g09 < $SLURM_JOB_NAME.g09')
    slurmfile.write('\n')
